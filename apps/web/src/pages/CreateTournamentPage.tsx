  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      await db.tournaments.put({
        ...
        publicToken: null,
        publicEnabled: false,
        certEmailSubject: DEFAULT_CERT_EMAIL_SUBJECT,
        certEmailBody: DEFAULT_CERT_EMAIL_BODY,
        certSerialPrefix: DEFAULT_CERT_SERIAL_PREFIX,
        certSerialPad: DEFAULT_CERT_SERIAL_PAD,
        certSerialNext: 1,
        updatedAt: now,
        dirty: 1,
      });
        ...
        <div className="form-group">
          ...
          {style === 'dutch' && (
            <p className="form-hint">
              Boards are generated by bbpPairings v6 (FIDE Dutch 2026).
            </p>
          )}
        </div>
